 ...
 */
public class BuyTransactionTableModel extends AbstractTableModel{

    private final Invoice invoice;
    private final String[] columns = {"SKU", "Title", "Condition", "Price"};

    public BuyTransactionTableModel(Invoice i){
        this.invoice = i;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch(columnIndex){
            ...
            case 3: return Double.toString(item.getUSED_COST());
        }
        return null;
    }
